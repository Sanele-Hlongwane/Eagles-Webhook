          ...
          <form onSubmit={handleSubmit} className="max-w-lg mx-auto">
            <div className="mb-4">
              ...
              <input
                ...
                required
                className="mt-1 block w-full px-3 py-2 border border-gray-300 bg-gray-800 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 text-white"
              />
            </div>
